...
DomainErrorTranslator._directories = {
  ...
  'DETAIL_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat menemukan thread karena properti yang dibutuhkan tidak ada'),
  'DETAIL_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat menemukan thread karena tipe data tidak sesuai'),
  ...
  'NEW_COMMENT_REPLY.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat balasan komentar baru karena properti yang dibutuhkan tidak ada'),
  'NEW_COMMENT_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat balasan komentar baru karena tipe data tidak sesuai'),
};
